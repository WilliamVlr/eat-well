...
<head>
  ...
  <style>
    ...
    .welcome-banner {
        display: flex;
        align-items: center;
        background: linear-gradient(to right, #C6E4B7, #aaf3c5); /* gradasi hijau muda */
        border-radius: 20px;
        padding: 5px 10px;
        max-width: 800px;
    ...
    @keyframes leafFall {
        ...
        25% { opacity: 0.7; }
        50% { transform: translateX(-50px) translateY(50vh) rotate(180deg); opacity: 1; }
...
<body>
    ...
    <div class="text-muted-subheading text-center" style="font-family: 'Roboto', sans-serif;">You can download the whole report of your sales</div>
